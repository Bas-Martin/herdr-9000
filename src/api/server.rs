...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::AutomationCreate(_) => "automation.create",
        Method::AutomationList(_) => "automation.list",
        Method::AutomationUpdate(_) => "automation.update",
        Method::AutomationDelete(_) => "automation.delete",
        Method::AutomationRunNow(_) => "automation.run_now",
        Method::TaskChecks(_) => "task.checks",
        Method::ExternalTrackerConfigure(_) => "external.configure",
        Method::ExternalIssueSearch(_) => "external.search",
        Method::ExternalIssueTaskCreate(_) => "external.task_create",
        Method::ResourceCreate(_) => "resource.create",
        Method::ResourceList(_) => "resource.list",
        Method::ResourceUpdate(_) => "resource.update",
        Method::ResourceDelete(_) => "resource.delete",
        ...
        Method::AgentStartTmux(_) => "agent.start_tmux",
        Method::AgentPrompt(_) => "agent.prompt",
        Method::TmuxPaneList(_) => "tmux.list",
        Method::TmuxPaneCapture(_) => "tmux.capture",
        Method::TmuxPaneSendKeys(_) => "tmux.send_keys",
        Method::TmuxPaneKill(_) => "tmux.kill",
        Method::TmuxPaneFocus(_) => "tmux.focus",
