...
pub(crate) fn request_changes_ui(request: &Request) -> bool {
    matches!(
        ...
        Method::ServerReloadConfig(_)
            ...
            | Method::ResourceCreate(_)
            | Method::ResourceUpdate(_)
            | Method::AutomationCreate(_)
            | Method::AutomationUpdate(_)
            | Method::AutomationDelete(_)
            | Method::AutomationRunNow(_)
            | Method::ResourceDelete(_)
